...
export function Contact ({}: Props) {
  return (
    ...
    <div className="w-full">
        ...
        <p className='w-full text-opacity-0 flex'>Kontakt telefoniczny i wizyta przed podpisaniem umowy to dla nas chleb powszedni. Po wstępnych rozmowach i wycenie podpisujemy umowę, wchodzimy na miejsce prac, niezwłocznie zabierając się do pracy.
